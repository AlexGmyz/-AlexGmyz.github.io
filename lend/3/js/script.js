$(document).ready(function() {
	...
	$('.parallax__mountain__1').css('transform','scale('+z_2+')');

		var z_3=1+(w*0.000005*p_b);
		var hr=w/2000*p_b;

	$('.parallax__mountain__2').css('transform', 'translate3d('+hr+'px,0,0) scale('+z_3+')');

		var z_4=1+(w*0.00001*p_b);
		var hr_2=w/1500*p_b;

	$('.parallax__mountain__3').css('transform', 'translate3d('+hr_2+'px,0,0) scale('+z_4+')');
	});
});